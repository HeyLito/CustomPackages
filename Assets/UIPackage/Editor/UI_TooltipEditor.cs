...
namespace CustomUI.Editors
{
    ...
    public class UI_TooltipEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ((Constraint)_contentConstraint.enumValueIndex == Constraint.Other)
            {
            ...
            if ((Constraint)_contentConstraint.enumValueIndex != Constraint.None)
            {
                EditorGUI.indentLevel = 1;
        ...
        private void SetContentPosition()
        {
            ...
            UI_Projection offsetProjection = new UI_Projection(_target.content, _target.transform.position + UI_Utility.ConvertPositionToScreenConstant(new Vector3(_target.offsetFromPointer.x, _target.offsetFromPointer.y)));
